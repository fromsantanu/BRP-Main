...
- [Extracting year, month, day, hour, minute, and second: year(), month(), day(), hour(), minute(), second()](#)
- [Extracting week and weekday: week(), wday()](#)
...
- [Handling incomplete dates with ym(), yq(), yd()](#)
